...
const 설정 = {
  ...
  */
  시작_속도: 3.5,            // 스테이지 1의 속도 (낮을수록 여유롭습니다)
  스테이지마다_빨라짐: 0.45,  // 보스를 하나 이길 때마다 이만큼 빨라집니다
  최대_속도: 9,              // 아무리 빨라져도 여기까지
...
function 보스_쓰러짐() {
  ...
  알림띄우기(빨라졌나
    ? `보스 격파!  +${설정.보스_점수}점  ·  스테이지 ${스테이지} — 조금 빨라집니다`
    : `보스 격파!  +${설정.보스_점수}점  ·  스테이지 ${스테이지}`, 150);
